namespace ClinetPrints.SettingWindows.SettingOtherWindows
{
    partial class parmSetting
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.groupBox5.Size = new System.Drawing.Size(400, 452);
            ...
            this.cmb_printModel.Items.AddRange(new object[] {
            "卡打印",
            "卡擦除"});
            ...
            this.cmb_printModel.KeyPress += new System.Windows.Forms.KeyPressEventHandler(this.cmb_printModel_KeyPress);
            // 
            // cmb_wipeTemperatuer
            // 
            this.cmb_wipeTemperatuer.FormattingEnabled = true;
            this.cmb_wipeTemperatuer.Items.AddRange(new object[] {
            "0",
            "1",
            "2",
            "3",
            ...
            this.cmb_wipeTemperatuer.KeyPress += new System.Windows.Forms.KeyPressEventHandler(this.cmb_wipeTemperatuer_KeyPress);
            // 
            // cmb_wipeSheep
            // 
            this.cmb_wipeSheep.FormattingEnabled = true;
            this.cmb_wipeSheep.Items.AddRange(new object[] {
            "0",
            "1",
            "2",
            "3",
            ...
            this.cmb_wipeSheep.KeyPress += new System.Windows.Forms.KeyPressEventHandler(this.cmb_wipeSheep_KeyPress);
            // 
            // cmb_grayTemperature
            // 
            this.cmb_grayTemperature.FormattingEnabled = true;
            this.cmb_grayTemperature.Items.AddRange(new object[] {
            "0",
            "1",
            "2",
            "3",
            ...
            this.cmb_grayTemperature.KeyPress += new System.Windows.Forms.KeyPressEventHandler(this.cmb_grayTemperature_KeyPress);
            // 
            // cmb_printSheep
            // 
            this.cmb_printSheep.FormattingEnabled = true;
            this.cmb_printSheep.Items.AddRange(new object[] {
            "0",
            "1",
            "2",
            "3",
            ...
            this.cmb_printSheep.KeyPress += new System.Windows.Forms.KeyPressEventHandler(this.cmb_printSheep_KeyPress);
            // 
            // cmb_printContrast
            // 
            this.cmb_printContrast.Enabled = false;
            this.cmb_printContrast.FormattingEnabled = true;
            this.cmb_printContrast.Items.AddRange(new object[] {
            "0",
            "1",
            "2",
            "3",
            ...
            this.cmb_printContrast.KeyPress += new System.Windows.Forms.KeyPressEventHandler(this.cmb_printContrast_KeyPress);
            // 
            // cmb_printTemperature
            // 
            this.cmb_printTemperature.FormattingEnabled = true;
            this.cmb_printTemperature.Items.AddRange(new object[] {
            "0",
            "1",
            "2",
            "3",
            ...
            this.cmb_printTemperature.KeyPress += new System.Windows.Forms.KeyPressEventHandler(this.cmb_printTemperature_KeyPress);
            // 
            // cmb_outCardWay
            // 
            this.cmb_outCardWay.FormattingEnabled = true;
            this.cmb_outCardWay.Items.AddRange(new object[] {
            "装卡盒接收",
            "手动接收",
            "后退卡",
            "不退卡"});
            ...
            this.cmb_outCardWay.KeyPress += new System.Windows.Forms.KeyPressEventHandler(this.cmb_outCardWay_KeyPress);
            // 
            // cmb_inCardWay
            // 
            this.cmb_inCardWay.FormattingEnabled = true;
            this.cmb_inCardWay.Items.AddRange(new object[] {
            "卡盒自动送卡",
            "手动送卡",
            "自动选择"});
            ...
            this.cmb_inCardWay.KeyPress += new System.Windows.Forms.KeyPressEventHandler(this.cmb_inCardWay_KeyPress);
            // 
            // cmb_cardType
            // 
            ...
            this.cmb_cardType.KeyPress += new System.Windows.Forms.KeyPressEventHandler(this.cmb_cardType_KeyPress);
            // 
            // cmb_wipeType
            // 
            this.cmb_wipeType.FormattingEnabled = true;
            this.cmb_wipeType.Items.AddRange(new object[] {
            "不擦除",
            "全部擦除",
            "前景位图大小擦除",
            "用户自定的位图擦除"});
            ...
            this.cmb_wipeType.KeyPress += new System.Windows.Forms.KeyPressEventHandler(this.cmb_wipeType_KeyPress);
            // 
            // label11
            // 
